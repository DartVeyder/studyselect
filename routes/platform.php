...
use App\Orchid\Screens\Student\StudentSheetListScreen;
use App\Orchid\Screens\Student\StudentSpecialtyListScreen;
...
Route::get('/sheet', function (StudentsSheet $sheets) {

    $students = $sheets->getStudentByEmail('dmytro.medvid@dspu.edu.ua');
    dd($students);
